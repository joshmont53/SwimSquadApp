...
import {
  ...
  UserCog, Users, Shield, MapPin, Trophy, LogOut, ChevronLeft, ChevronRight, Home, BookOpen, TrendingUp, UserCheck, LayoutList
} from 'lucide-react';
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    />
                    {!collapsed && <span className="flex-1 text-left">Performance Analysis</span>}
                  </Button>
                </TooltipTrigger>
                {collapsed && <TooltipContent side="right">Performance Analysis</TooltipContent>}
              </Tooltip>
