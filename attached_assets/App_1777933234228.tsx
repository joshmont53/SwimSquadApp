...
import { Menu, CalendarDays, List, Plus, FileText, Target, Receipt, BarChart3, UserCog, Users, Shield, MapPin, Trophy, LogOut, ChevronLeft, ChevronRight, Home, Search, BookOpen, TrendingUp, UserCheck } from 'lucide-react';
...
import { Session, Competition, QualificationLevel, RecurringSession, CoverRequest, Availability } from './types';
...
type ManagementView = 'home' | 'calendar' | 'coaches' | 'squads' | 'swimmers' | 'locations' | 'competitions' | 'addSession' | 'sessionLibrary' | 'drillsLibrary' | 'invoiceTracker' | 'feedbackAnalytics' | 'swimmerProfiles' | 'swimmerProfile' | 'handbook' | 'attendanceAnalysis' | 'scheduleManager' | 'availabilityCover';
