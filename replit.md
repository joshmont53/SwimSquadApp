...
- **Handbook**: Document management system plus handbook notes, with two tabs:
  - **Documents tab**: Coaches upload, categorize, preview, and download documents (PDF, Word, Excel) stored in localStorage as base64. Features drag-and-drop upload, 6 categories, search/filter, full preview, delete confirmation, and download.
